...
/* include the following line if you are running under Unix environment
**/
// #include <unistd.h>

/* include the following line if you are running under Windows environment 
** "XGetopt.h" and "XGetopt.cpp" can be download at
